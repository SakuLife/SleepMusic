...
- `KIEAI_NANOBANANA_BG_MODEL=google/nano-banana` - Background image model (no text)
- `KIEAI_NANOBANANA_THUMB_MODEL=google/nano-banana-pro` - Thumbnail model (supports Japanese text)
